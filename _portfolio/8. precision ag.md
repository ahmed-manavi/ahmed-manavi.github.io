...
excerpt: "Leveraging Sentinel-2 time-series data and deep learning to extract vegetation phenology metrics and deliver accurate crop mapping for precision agriculture"
header:
  teaser: "example7.gif"
...
**StoryMap reference:** an ArcGIS StoryMap titled *"Deep Learning Based High-Resolution Crop Mapping"* that illustrates the full workflow, from Sentinel-2 data through phenology extraction to trained model outcomes.
