...
header:
  teaser: "rir-model-architecture.png"
weight: 3
venue: "Bose Corporation Co-Op"
---


![Room Geometry Estimation Model Architecture](/images/rir-model-architecture.png)
...
- **Deep Learning Model:** Designed a multi-loss function neural network (MSE + L1 losses) for accurate dimension regression.
...
3. **Cross-Validation** – Trained on 3 rooms, validated on 1, tested on 1 for unbiased performance assessment.  
